...
class ValidateEntry {
    ...
    getAlbumsForArtistHandler(unqfy, objs){
        return unqfy.getAlbumsForArtist(this.validArgumentsCheck(["name"],objs).name);
    }
    ...
    functionList = {
        ...
        getAlbumsForArtist : (unqfy, artistName) => this.getAlbumsForArtistHandler(unqfy,artistName)
    }
